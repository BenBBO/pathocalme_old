...
export default function Home2() {
    ...
    return <div id="home-page">
        ...
        <Grid container className="home-item-container" style={{ backgroundColor: "white" }}>
        ...
        <Grid container className="home-item-container" style={{ backgroundColor: "white" }}>
            ...
            <Grid xs={6}>
                <img alt="pédagogie" className="right-aligned" src={require("Assets/Images/pedagogie.jpg")} />
            </Grid>
        </Grid>
